...
def parse_args():
    ...
    parser.add_argument("--embedder", type=str, default="ISEB-Syn")
    ...
    parser.add_argument("--message_passing", type=int, default=2)
    ...
    parser.add_argument("--EM_NUM", type=int, default=5)

    # train dataset
    parser.add_argument("--dataset", type = str, default = 'GDSC640', help = 'ZhangDDI / ChChMiner / DeepDDI')
